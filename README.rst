...
A: I only work parttime on this, so I don't really. As soon the project reaches a state where there is a stable fundament, 
I'll force push with "Initial Commit" comment and stick to the common rules (atomic commits, descriptive comments, etc.). 
